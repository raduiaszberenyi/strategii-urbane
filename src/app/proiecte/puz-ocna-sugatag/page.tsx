...
export default function PuzOcnaSugatagPage() {
  return (
      ...
      <section className="px-8 py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="max-w-4xl text-2xl leading-relaxed text-zinc-600">
            ...
            urbanistică a zonei studiate din Ocna Șugatag.
          </p>
        </div>
      </section>
      ...
      <section className="px-8 pb-20">
        <div className="mx-auto max-w-7xl">
          <div className="relative h-[640px] overflow-hidden rounded-[44px] bg-zinc-100">
            <Image
              src="/images/portofolio/puz/puz-ocna-sugatag.jpg"
              alt="PUZ Ocna Șugatag"
              fill
              priority
              sizes="100vw"
        ...
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-[1fr_2fr]">
          <div>
            ...
            <div className="space-y-5 text-zinc-600">
              <p>
                <span className="text-zinc-950">Localizare:</span> Ocna Șugatag,
                județul Maramureș
              </p>
          ...
          <div>
            ...
            <p className="mb-6 text-lg leading-relaxed text-zinc-600">
              Documentația stabilește reglementările urbanistice aplicabile
              zonei studiate și condițiile necesare dezvoltării acesteia.
            </p>

            <p className="text-lg leading-relaxed text-zinc-600">
              Propunerea urmărește organizarea coerentă a terenurilor și
              integrarea noilor intervenții în structura localității.
            </p>
          </div>
        </div>
      </section>

...
export default function PuzMetroPage() {
  return (
      ...
      <section className="px-8 pb-20">
        <div className="mx-auto max-w-7xl">
          <div className="relative h-[640px] overflow-hidden rounded-[44px] bg-zinc-100">
            <Image
              src="/images/portofolio/puz/puz-metro.jpg"
              alt="PUZ Metro"
              fill
              priority
              sizes="100vw"
        ...
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-[1fr_2fr]">
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed text-zinc-600">
              Soluția urmărește corelarea funcțiunilor propuse cu structura
              existentă, circulațiile, accesibilitatea și infrastructura
              tehnico-edilitară.
            </p>
          </div>
        </div>
